...
export default function GoldenStandard() {
    return (
        <section className="relative min-h-screen snap-start grid grid-cols-1 md:grid-cols-2 gap-10 px-6 py-20 md:px-12 md:py-0 items-center border-b-2 border-oasis-gold overflow-hidden">
            {/* Background Image */}
            <img
                src={background2}
            ...
            <div className="relative z-10 flex justify-center items-center order-1 md:order-2">
                <img
                    ...
                    className="w-full max-w-[350px] md:max-w-md h-auto object-contain drop-shadow-2xl hover:scale-105 transition-transform duration-500"
                />
            </div>
        </section>
    )
